$(document).ready(function () {
    ...
    function stageChart() {
        $.post('/contratacionesabiertas/stage-chart-data', {
            ...
            var nData = [[],[],[],[],[]];
            var ticks = ['Licitación pública', 'Adjudicación directa art.41', 'Adjudicación directa art.42', 'Excepciones al reglamento', 'Invitación a cuando menos tres personas', 'Convenio de colaboración', 'Adhesiones y membresías'];
            var chartOptions = {
                height: 450,
                stackSeries: true,
                seriesDefaults: {
            ...
            function resizeHandler () {
                if (window.innerWidth < 700) {
                    ...
                    chartOptions['axes']['yaxis']['ticks'] = ['Licitación pública', 'Adjudicación directa art.41', 'Adjudicación directa art.42', 'Excepciones al reglamento', 'Invitación a cuando menos tres personas', 'Convenio de colaboración', 'Adhesiones y membresías']; //procedimiento por etapas
    ...
    $.post('/contratacionesabiertas/bubble-chart-data', {
        ...
        var options = {
          ...
          // Gráfica Contrataciones en el tiempo
            	'Adjudicación directa art.41': {color: '#00cc99'},
                'Adjudicación directa art.42': {color: 'gray'},
                'Invitación a cuando menos tres personas': {color: '#663399'},
                'Excepciones al reglamento': {color: '#ff6600'},
                'Licitación pública': {color: '#ffcc00'},
                'Convenio de colaboración': {color: '#00BFFF'},
                'Adhesiones y membresías': {color: '#ff0000'}           
            },
            legend: {
                textStyle: {
                	fontName: 'Open Sans',
